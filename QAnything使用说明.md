...
**对于电脑内存的最低占用量**
###### 注：以下数据仅为测试值，仅供参考；在Mac操作系统的内存优化下，16GB内存无论是运行openai还是3B模型都会将内存全部占满，但是不会使程序崩溃，所以在Mac上使用QAnything时推荐使用内存16GB以上的电脑，内存8GB的电脑无法正常使用
| 电脑操作系统                                | 启动方式                                                                            | 文件解析内存用量                                                                    | 模型问答内存用量                                                                            |
|-----------------------------------|---------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|----------------------------------------------------------------|
| Mac                            | openai和3B模型                                                               | 7GB                                                   |                                16GB+                                |                                          
| Linux云服务器（Ubuntu环境）                            | openai                                                               | 6.1GB                                                   |                                9.7GB                                |                                             |
| Linux云服务器（Ubuntu环境）                            | 3B                                                               | 12.7GB                                                   |                                15.1GB                               |                                             
| Windows下的wsl开发环境（Ubuntu环境）                            | openai                                                               | 8.1GB                                                   |                                10.0GB                               |                                             
| Linux云服务器（Ubuntu环境）                            | 3B                                                               | 12.0GB                                               |                                12.4GB                               |                                             
